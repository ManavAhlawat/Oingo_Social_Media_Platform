...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$sql5 = "INSERT INTO user_state(UID,UserState) Values ('$userid','$user_state')";
	$con->query($sql5);
	$sql2 = "INSERT INTO tag(tagID,TagName)  Values  (default,'$tag')";
	$con->query($sql2);
	$lastid_tag = mysqli_insert_id($con);
	$sql3 = "INSERT INTO Schedule(SchID,Start_Date,End_Date,Start_Time,End_Time,Recurring,Day_of_week) Values (default,'$start_date','$end_date','$start_time','$end_time','$recur','$day')";
	$con->query($sql3);
	...
	$sql6 = "INSERT INTO note_tag (NoteID,TagID) Values ('$lastid','$lastid_tag')";
	$con->query($sql6);
